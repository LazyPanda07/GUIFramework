...
namespace gui_framework
{
	namespace utility
	{
		BaseComponent* ChildWindowCreator::create(const wstring& windowName, const utility::ComponentSettings& settings, const any& additionalData, BaseComposite* parent)
		{
