...
namespace gui_framework
{
	...
	{
		BaseComponent* MultipleSelectListBoxDeserializer::deserialize(const std::string& componentName, const json::utility::jsonObject& description, BaseComposite* parent) const
		{
