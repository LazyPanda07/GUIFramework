...
void test()
{
	...
	try
	{
		...
		GroupBox* box = new GroupBox(L"Box", L"Some text here", 0, 0, 400, 400, ptr);

		box->addRadioButton(L"First", L"First", 0, 0, 200, 20, [](WPARAM, LPARAM) { cout << "First" << endl; return 0; });

		box->addRadioButton(L"Second", L"Second", 0, 20, 200, 20, [](WPARAM, LPARAM) { cout << "Second" << endl; return 0; });
